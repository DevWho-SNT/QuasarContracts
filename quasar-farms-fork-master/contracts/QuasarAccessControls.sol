...
// Forked from Digitalax Platform code

pragma solidity ^0.8.4;

import "./deps/AccessControl.sol";

/**
 * @notice Access Controls contract for QuasarSwap
 * @author BlockRocket.tech
 */

contract QuasarAccessControls is AccessControl {
