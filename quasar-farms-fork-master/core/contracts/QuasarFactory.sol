...
contract QuasarFactory is IQuasarFactory {
    bytes32 public constant INIT_CODE_PAIR_HASH = keccak256(abi.encodePacked(type(QuasarPair).creationCode));
    ...
    function setFeeTo(address _feeTo) external {
        require(msg.sender == feeToSetter, 'Quasar: FORBIDDEN');
        feeTo = _feeTo;
    }
